...
You can install the development version of `ctisglobal` from [GitHub](https://github.com/) with:
...
Fetch all the available indicators for CTIS opendata and their corresponding description and  ranges of dates for which the question is asked in the survey.
